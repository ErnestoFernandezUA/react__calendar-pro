...
export interface ControlsWeatherState {
...
const initialState: ControlsWeatherState = {
...
export const getWeatherAsyncAll = createAsyncThunk(
  ...
  async (
    ...
    const { displayed } = store.controlsWeather;
...
const controlsWeatherSlice = createSlice({
  name: 'controlsWeather',
  initialState,
  reducers: {
    ...
    changeDisplayed: (
      state: ControlsWeatherState, action: PayloadAction<CityData[]>,
    ) => {
    ...
    setCurrent: (
      state: ControlsWeatherState, { payload }: PayloadAction<CityData>,
    ) => {
    ...
    checkCurrent: (state: ControlsWeatherState) => {
    ...
    clearWeekWeather: (state: ControlsWeatherState) => {
      state.weekWeather = initialState.weekWeather;
      state.errorWeekWeather = initialState.errorWeekWeather;
      state.statusWeekWeather = initialState.statusWeekWeather;
    },
    sortTable: (
      state: ControlsWeatherState, { payload }: PayloadAction<Sort | undefined>,
    ) => {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getWeekWeatherAsync.pending, (state: ControlsWeatherState) => {
...
export default controlsWeatherSlice.reducer;
export const {
  saveKeys,
  changeDisplayed,
  addSelected,
  ...
  setDisplayed,
  resetState,
} = controlsWeatherSlice.actions;

export const selectAllData
= (state: RootState) => state.controlsWeather.allData;
export const selectAllKeys
= (state: RootState) => state.controlsWeather.allKeys;

export const selectSelectedCountries
= (state: RootState) => state.controlsWeather.selectedCountries;
export const selectSelected
= (state: RootState) => state.controlsWeather.selected;
export const selectDisplayed
= (state: RootState) => state.controlsWeather.displayed;
export const selectCurrent
= (state: RootState) => state.controlsWeather.current;
export const selectSortBy = (state: RootState) => state.controlsWeather.sortBy;
export const selectOrder = (state: RootState) => state.controlsWeather.order;
export const selectLoadingList
= (state: RootState) => state.controlsWeather.loadingList;
export const selectErrors = (state: RootState) => state.controlsWeather.errors;
export const selectStatus = (state: RootState) => state.controlsWeather.status;

export const selectWeekWeather
= (state: RootState) => state.controlsWeather.weekWeather;
export const selectStatusWeekWeather
= (state: RootState) => state.controlsWeather.statusWeekWeather;
export const selectErrorWeekWeather
= (state: RootState) => state.controlsWeather.errorWeekWeather;
